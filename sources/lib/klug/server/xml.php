 ...
 * Time: 18:20
 */
class klug_server_xml extends Zend_XmlRpc_Server
{
    protected $_storeid;
    protected $_key;
    ...
    public function getStoreId()
    {
        ...
        $this->_storeid = array_pop($params);
    ...
    protected function _handle(Zend_XmlRpc_Request $request)
    {
        ...
        //Removing store id parameter from params set to be called
        $key = array_pop($params);
        $this->_storeid = array_pop($params);


        //Removing type of removed parameter to pass types validation
        array_pop($sigCalled);
        array_pop($sigCalled);
