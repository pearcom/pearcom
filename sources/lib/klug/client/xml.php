 ...
 * Time: 20:42
 */
class klug_client_xml extends Zend_XmlRpc_Client
{
    protected $_storeid;
    protected $_key;
    ...
    protected function _createRequest($method, $params)
    {
        ...
        $request->addParam($this->_storeid,"string");
        $request->addParam($this->_key,"string");
        return  $request;
    }
    ...
    public function getProxy($namespace = '')
    {
        if (empty($this->_proxyCache[$namespace])) {
            $proxy = new klug_client_proxy($this, $namespace);
