 ...
 * Time: 1:26
 */
class products_model_product_local extends klug_model_abstract
{
    ...
    protected $_entityTableName = 'product';
    protected $_item;
    protected $_entityTableFields = array("category_id"=>"INT(20) NULL DEFAULT NULL","title"=>"VARCHAR(50) NULL DEFAULT NULL"
    ...
    public function find($string)
    {
        ...
        while(strlen($b)>0)
        {
            ...
            $products = $this->loadAllId($b);

            $products2 = $this->loadByAttributeLike($b);
            $result = array_merge($products,$products2,$result);
